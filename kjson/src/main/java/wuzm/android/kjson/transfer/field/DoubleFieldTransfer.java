...
/**
 * 支持double、Double类型的转换
 *
 * Created by kernel on 15/3/18.
 * Email: 372786297@qq.com
 */
public class DoubleFieldTransfer extends FieldInfo implements FieldTransfer {
    public DoubleFieldTransfer(Class fieldClass, Type fieldType, Field field) {
